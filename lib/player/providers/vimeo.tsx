...
export function VimeoPlayer({ videoId, sourceUrl, onReady, onError }: { videoId?:string; sourceUrl:string; onReady?:()=>void; onError?:(m:string)=>void }){
  ...
  const embed = `https://player.vimeo.com/video/${id}?dnt=1&title=0&byline=0&portrait=0`;
