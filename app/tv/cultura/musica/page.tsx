...
export default function Page(){
  ...
  return <div className="py-6 space-y-6"><h1 className="text-2xl font-black capitalize">Cultura · musica</h1><div className="grid grid-cols-2 md:grid-cols-4 gap-4">{items.map(c=> <VerticalCard key={c.id} item={c} />)}</div>{items.length===0 && <p className="text-sm text-[#6b6b6b]">Conteúdos em breve.</p>}</div>;
}
