...
export const epgChannels: EpgChannel[] = [
  ...
  { id:"cubavision", slug:"cubavision", name:"Cubavisión", shortName:"Cubavisión", description:"Televisión Cubana.", country: epgCountries[9], region:"La Habana", city:"La Habana", language:"es", logo:"", cover:"", category:"Público", timezone:"America/Havana", channelNumber:6, is24h:true, status:"OFFLINE", isActive:false,
    source:{ type:"iframe", provider:"iframe", url:"https://example.com/cubavision", isLive:true },
    schedule: [],
  },
  { id:"musica-sur", slug:"musica-del-sur", name:"Música del Sur", shortName:"Música Sur", description:"Música latina independente.", country: epgCountries[0], region:"Buenos Aires", city:"Buenos Aires", language:"es", logo:"", cover:"", category:"Música", timezone:"America/Argentina/Buenos_Aires", channelNumber:12, is24h:true, status:"SCHEDULED", isActive:true,
  ...
  { id:"patagonia-cultura", slug:"patagonia-cultura", name:"Patagonia Cultura", shortName:"Patagonia", description:"Cultura da Patagônia.", country: epgCountries[3], region:"Montevideo", city:"Montevideo", language:"es", logo:"", cover:"", category:"Regional", timezone:"America/Montevideo", channelNumber:3, is24h:false, status:"UNKNOWN", isActive:true,
    source:{ type:"hls", provider:"hls", url:"https://test-streams.mux.dev/x36xhzz/x36xhzz.m3u8", isLive:true },
